...
<head>
    ...
    <title>Xəbər Saytı</title>
    <style>
        body { font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4; }
        .container { max-width: 800px; margin: 20px auto; background: white; padding: 20px; border-radius: 10px; }
        .header { text-align: center; padding: 10px 0; background: black; color: white; font-size: 24px; font-weight: bold; }
        .news-category { background: #ddd; padding: 5px 10px; display: inline-block; border-radius: 5px; font-size: 14px; }
        .news-item { padding: 20px 0; }
        .news-item h2 { font-size: 22px; margin-bottom: 10px; }
        .news-item p { font-size: 16px; color: #555; line-height: 1.6; }
        .news-item .date { font-size: 14px; color: #888; margin-bottom: 10px; }
        .news-title { font-size: 20px; font-weight: bold; text-align: center; margin-top: 10px; }
        .read-more { display: inline-block; margin-top: 10px; color: white; background: blue; padding: 10px 15px; text-decoration: none; border-radius: 5px; }
        .news-item hr { margin: 20px 0; border: 1px solid #ddd; }
    </style>
</head>
<body>
